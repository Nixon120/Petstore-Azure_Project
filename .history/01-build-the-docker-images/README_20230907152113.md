...
`docker run --rm --net petstorebridge --name petstoreapp -p 8089:8089 -e PETSTOREAPP_SERVER_PORT=89890-e PETSTOREPETSERVICE_URL=http://172.28.0.2:8081 -e PETSTOREPRODUCTSERVICE_URL=http://172.28.0.3:8082 -e PETSTOREORDERSERVICE_URL=http:// 172.28.0.4:8083 -d petstoreapp:latest`
